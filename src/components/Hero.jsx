...
function Hero() {
  return (
    <div className='grid lg:grid-cols-2 gap-24 items-center'>
        ...
        <div className='hidden md:carousel h-[28rem] carousel-center p-4 space-x-4 bg-neutral rounded-box'>
            {
                carouselImages.map((image) => {
                    return(
                        <div key={image} className="carousel-item">
                            <img src={image} alt="" className='rounded h-full w-80 object-cover' />
                        </div>
                    )
                })
            }
